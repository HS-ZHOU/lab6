...
ncburl <- "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi"
library(httr)
query_ids <- GET(
  url   = ncburl,
...
institution <- str_extract_all(
  publications_txt,
  "University[[:space:]]of[[:space:]][[:alnum:]]+|[[:alnum:]]+[[:space:]]Institute[[:space:]]of[[:space:]][[:alnum:]]+"
  ) 
...
schools_and_deps <- str_extract_all(
  publications_txt,
  "School[[:space:]]of[[:space:]][[:alnum:]]+|Department[[:space:]]of[[:space:]][[:alnum:]]+"
  )
...
_None of them don't have a title._
